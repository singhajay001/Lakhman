...
- **Command:** `"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run moz_api.py`
...
- **Command:** `"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run bing_webmaster.py`
...
- **Command:** `"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run commoncrawl_graph.py`
...
- **Command:** `"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run verify_backlinks.py`
