...
2. Use `"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run render_page.py URL --mode auto --json
...
```bash
"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run pagespeed_check.py URL --json
"$CLAUDE_PROJECT_DIR/.claude/seo-toolkit/bin/claude-seo" run crux_history.py URL --json
```
